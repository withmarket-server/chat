...
let EventsGateway = class EventsGateway {
    ...
    async events(message) {
        ...
        this.socket.to(message.group).emit('events', message);
        return;
    }
...
], EventsGateway.prototype, "socket", void 0);
__decorate([
...
], EventsGateway.prototype, "events", null);
__decorate([
    (0, common_1.UsePipes)(new common_1.ValidationPipe()),
    (0, common_1.UseFilters)(new filter_1.AllExceptionsFilter()),
    (0, websockets_1.SubscribeMessage)('messagePassing'),
    __param(0, (0, websockets_1.MessageBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [message_1.Message]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, group_1.Group]),
